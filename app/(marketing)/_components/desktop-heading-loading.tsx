...
const DesktopHeadingLoading = () => {
  return (
    <>
      <div className={cn("lg:flex hidden flex-row justify-center items-center lg:gap-x-10 sm:gap-x-5 mt-20 px-20")}>
        <div
          className={
            "flex flex-col justify-between h-full items-center basis-1/3 transition-all drop-shadow-lg -skew-y-3 -translate-x-4 scale-90"
          }
        >
        ...
        <div
          className={cn(
            "flex flex-col justify-between items-center basis-1/3 transition-all h-full -translate-y-8 scale-90"
          )}
        >
          <ul
            className={cn("grid grid-rows-8 p-2 grid-flow-col gap-2 w-full duration-150 transition-all drop-shadow-lg")}
          >
      ...
      <div className={cn("lg:hidden flex flex-row justify-center gap-x-6 mt-24 px-12 w-full")}>
        <div
          className={
            "flex flex-col justify-between h-full items-center basis-1/2 transition-all drop-shadow-lg -skew-y-3 -translate-x-4 scale-90"
          }
        >
          <div className="flex flex-col justify-center items-center w-full">
        ...
        <div
          className={cn(
            "flex flex-col w-full justify-between items-center basis-1/2 transition-all h-full skew-y-3 translate-x-4 scale-90"
          )}
        >
          <ul
            className={cn("grid grid-rows-8 p-2 grid-flow-col gap-2 w-full duration-150 transition-all drop-shadow-lg")}
