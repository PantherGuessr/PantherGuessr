...
export const Heading = () => {
    ...
    return (
        <div className="max-w-3xl space-y-4">
            {isLoading && (
                <div className="grid">
                <Skeleton className="justify-self-center m-1 h-16 w-[500px]" />
                <Skeleton className="justify-self-center m-1 h-16 w-[800px]" />
                <Skeleton className="justify-self-center m-1 h-16 w-[700px]" />
                <Skeleton className="justify-self-center mt-6 h-8 w-[400px]" />
                <Skeleton className="justify-self-center mt-2 h-8 w-[400px]" />
                </div>
            )}
