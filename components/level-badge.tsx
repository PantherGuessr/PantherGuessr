...
const LevelBadge: React.FC<LevelBadgeProps> = ({ level }) => {
  ...
  return (
    <div
      className="xs:flex xs:justify-center relative mr-1 hidden items-center gap-x-2"
    ...
    >
      ...
      />
      <p
        className="absolute top-1/2 left-1/2 -translate-x-[51%] -translate-y-[45%] transform rounded-full px-1 text-sm font-bold text-white drop-shadow-md"
